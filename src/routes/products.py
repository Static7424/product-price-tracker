...
from src.models.product import Product, ProductHistoryResponse, ProductRegisterResponse, ProductResponse
...
def register_product(
    product_id: str = Form(
        ...,
        description = "Product ID to register."
    ),
    product_name: str = Form(
        ...,
        description = "Product name to register."
    ),
    product_url: str = Form(
        ...,
        description = "URL to the product to register."
    ),
...
def product_id_history(
    product_id: str = Path(
        ...,
        description = "Product ID to get historic prices for."
    ),
    db: Session = Depends(get_db)
):
    product = db.query(Product).filter(Product.product_id == product_id).first()
